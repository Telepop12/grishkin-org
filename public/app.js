...
const en = {
  ...
  "Фабрика, которая": "The fabric that",
  "делает эти системы.": "builds these systems.",
  "Наш операционный контур: AI анализирует репозиторий и формирует задачи, гейты проверяют инварианты, человек даёт «ДА» — и релиз уходит в прод. Живой конвейер — на отдельной странице.": "Our operating loop: AI analyses the repository and drafts tasks, gates check the invariants, a human says “YES” — and the release ships to production. The live conveyor has its own page.",
  "Открыть AI Fabric": "Open the AI Fabric",
  "◉ Анимированный конвейер задач": "◉ An animated task conveyor",
  "○ Принципы контура": "○ Principles of the loop",
  "○ Архитектура нового поколения": "○ Next-generation architecture",
