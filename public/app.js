...
const en = {
  ...
  "Два слоя": "Two layers",
  "лаборатории.": "of the lab.",
  "Фабрика — то, как мы работаем. Продукты — то, что мы делаем. У каждого слоя своя страница.": "The fabric is how we work. The products are what we make. Each layer has its own page.",
  "AI FABRIC · КАК МЫ РАБОТАЕМ": "AI FABRIC · HOW WE WORK",
  "Фабрика, на которой мы делаем эти системы.": "The fabric where we make these systems.",
  "Управляемая среда непрерывной интеграции AI в корпоративный контур: задачи рождаются из анализа, проходят гейты и приёмку с человеческим «ДА» — и уходят в прод.": "A governed environment for continuous AI integration into the corporate loop: tasks are born from analysis, pass the gates and a human “YES” at acceptance — and ship to production.",
  "задачи": "tasks",
  "гейт": "gate",
  "«ДА»": "“YES”",
  "прод": "prod",
  "Открыть AI Fabric ↗": "Open the AI Fabric ↗",
  "ПРОДУКТЫ · ЧТО МЫ ДЕЛАЕМ": "PRODUCTS · WHAT WE MAKE",
  "Системы, которые вышли из фабрики.": "The systems that came off the fabric.",
  "Три платформы на общем ядре — эксплуатация, безопасность, управленческие решения. Живые демо — в Live Lab, подробности — ниже.": "Three platforms on a shared core — operations, security, management decisions. Live demos in the Live Lab, details below.",
  "К системам ↓ · отдельная страница скоро": "To the systems ↓ · dedicated page coming soon",
